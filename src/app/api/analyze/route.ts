...
장르 발견하기 → 인디팝, 드림팝, 시티팝, 네오소울, 얼터너티브, 포스트록, 앰비언트팝, 침머, 로파이 범위 내에서 사진 분위기에 맞는 장르 선택. 노이즈·아방가르드·익스페리멘탈 등 마이너 장르 제외. Spotify popularity 30 이상이 확실한 곡만 추천. 본인이 Spotify에 실제로 존재한다고 확신하는 곡만 추천해줘. 한국 곡 60% 권장.
