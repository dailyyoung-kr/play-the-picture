...
{
  "selectedIndex": 번호,
  "reason": "3문장. 읽는 사람이 킥킥거리거나 '맞다 이거 나야' 느끼는 게 목표. ①사진의 구체적 디테일 하나를 관찰자 + 슬쩍 삐딱한 시선으로 묘사 (설명체 금지, 혼잣말·농담·자조 섞을 것) ②그 디테일과 곡의 성격을 연결. 곡을 살짝 의인화하거나 비유하는 것도 OK (예: '목소리가 벚꽃처럼 살살 내린다', '베이스가 어깨 툭 치는 무드') ③마무리는 매번 다른 형식으로: 확신/선언/과장/질문/반전/권유/비교 등에서 골라서. 평범한 '~어울려요', '~BGM이에요', '~딱이에요' 종결은 피할 것. 존댓말(~요/어요) 유지. 톤은 친한 언니/누나가 농담 섞어서 얘기하는 느낌.",
