...
const VIBE_TONE_POOL = [
  ...
  {
    name: "자기PR",
    reason_tone: "단톡방에 자기 PR 떠는 친구를 옆에서 알아봐주는 친구 톤. 사진 속 디테일을 '자기 자랑각', '인증샷각'으로 짚어주기. '이건 분위기 메이커 인증이네', '이 정도면 자랑 떨 만하지' 결. 친구로서 사용자의 자기 PR 결을 살려주는 카피. 허세·자뻑 OK, 농담 섞기.",
    desc_angle: "사진 속 본인의 디테일 1개를 자기 PR 카피로 풀기. '나 이런 사람이야', '이 정도는 기본이지' 자기 인증·허세 결. 단톡방에 친구한테 자랑 던지는 느낌. 허세·가벼운 호들갑 OK.",
    desc_examples: [
  ...
  {
    name: "유쾌발견",
    reason_tone: "친구가 사진에서 재미있는 디테일 발견. 'ㅋ 이거 봐봐' 결. 발견 + 위트.",
...
[분석 지시]
- 곡 분위기나 제목과 잘 어울리는 사진에서 가장 눈에 띄는 요소 1~2개를 자연스럽게 관찰해 reason에 녹일 것 (피사체의 동작·포즈, 장소, 색감·빛, 사물 상태 중)
- 여러 장이면 흐름·감정 변화·전체 무드 짚을 것
- reason 1번째 문장은 40자 이내로 간결하게

금지: '딱 맞아 떨어지다', '이건 그냥 A가 아니라 B', '그 자체로', 의문형 연속, 'ㅋ' 자음 단독, 태그 띄어쓰기, 'BGM' 사용 자제(같은 대화에서 여러 번 쓰지 말 것), '~어울려요' / '~딱이에요' / '~이만한 게 없어요' / '~결이 맞아요' 같은 평범한 종결 반복 금지
...
어미는 사진 소재와 자연스럽게 매칭되는 직업·역할·정체성 자유 선택 — 예: 요정/모델/주인공/탐험가/팬/스타일리스트/감독/사장님/단골/사색가/관찰자/디자이너/전문가/커플/찐친/중독자/유목민/러버/트렌드세터 등.
