...
금지: '딱 맞아 떨어지다', '이건 그냥 A가 아니라 B', '그 자체로', 의문형 연속, 'ㅋ' 자음 단독, 태그 띄어쓰기, 'BGM' 사용 자제(같은 대화에서 여러 번 쓰지 말 것), 'K-POP'을 '케이팝'으로 쓰지 말 것('K팝' 또는 '댄스팝'·'발라드' 등 서브장르), '~어울려' / '~딱이야' / '~이만한 게 없어' / '~결이 맞아' 같은 평범한 종결 반복 금지
