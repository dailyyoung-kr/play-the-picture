...
{
  "selectedIndex": 번호,
  "reason": "3문장. ①사진의 구체적 디테일(표정/색/사물 상태 등) 하나를 관찰자처럼 묘사 ②그 디테일과 곡의 구체적 특성(멜로디 질감, 리듬, 가사, 보컬 톤) 연결 ③위트있는 마무리 한 줄(매번 다른 형식—공감/과장/반전/의인화/확신 등 섞어서). 존댓말",
  ...
  "vibeType": "이모지 + 한글 캐릭터명. 3~7자. 자연스러운 한국어로, 억지로 글자수 맞추지 말 것. 띄어쓰기 허용. 매번 다른 어미 (예: 🌸 벚꽃 수집가 / 🎧 골목 DJ / 🍜 야식 헌터)",
  "vibeDescription": "25자 이내. 설명형 금지, 내면 고백이나 위트 있는 관찰 한 줄. 예: '벚꽃은 핑계고 사실 설레는 중' / '오늘 하루 봄에 잠식당함' / '커피 없으면 아무것도 안 됨'"${isDiscover ? ',\n  "discoveredGenre": "장르명 한국어"' : ""}
}`;
}
