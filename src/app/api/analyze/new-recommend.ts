...
{
  "selectedIndex": 번호,
  "reason": "3문장. 읽는 사람이 킥킥거리거나 '맞다 이거 나야' 느끼는 게 목표. ①사진의 구체적 디테일 하나를 관찰자 + 슬쩍 삐딱한 시선으로 묘사 (설명체 금지, 혼잣말·농담·자조 섞을 것) ②그 디테일과 곡을 연결. 단, 곡의 기술적 요소(기타 리프·멜로디·베이스·그루브·보컬톤)를 사진 디테일과 직접 매칭하지 말 것 — 억지스러워짐. 곡이 이 순간에 왜 맞는지를 네가 느끼는 방식대로 써. ③마무리 종결 패턴을 매번 다르게 돌려 쓸 것. 아래 예시에서 고르거나 비슷한 형식으로: 질문('~맞죠?'/'~아닌가요?'), 권유('~해봐요'/'~한번 해보자고요'), 과장·비교('~급이에요'/'~의 정석이죠'), 반전('~일 줄 누가 알았을까요'/'~인 척 하지만 사실'), 추측('~일지도 몰라요'), 확신('~만 기억나는 날이에요'), 명령조 농담('~금지'/'~의무입니다'). 피할 것: '~어울려요', '~BGM이에요', '~딱이에요', '~입니다/인정합니다' 종결 반복. 특히 '~입니다/합니다' 단정형 선언은 한 세션에 한 번만. 존댓말(~요/어요) 유지. 톤은 친한 언니/누나가 농담 섞어서 얘기하는 느낌.",
