...
// 곡 선택을 '제목 표면 매칭'이 아니라 '실제 곡 음악성'으로 유도 + _pick 내부 비교 필드로 다양성 확보.
// 2026-06-01: 시뮬+로컬 검증 — 제목 말장난 → 실제 곡 묘사로 reason 품질↑, _pick(곡명 2~3개 비교)이 다양성 엔진.
// _pick은 내부 사고용(응답·DB에 저장 안 됨). 트레이드오프: 분석 시간 소폭 증가.
...
{
  "_pick": "(내부용, 사용자에게 안 보임) 음악적으로 사진 무드에 맞는 후보 곡명 2~3개만 적고 → 최종 택1. 예: 푸른밤/Air/SEASONS→푸른밤. 제목 표면 매칭 말고 네가 아는 실제 곡 음악성으로 비교.",
  "selectedIndex": 번호,
